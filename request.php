                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td><button onclick="location.href='leaveDetail.php'"  class="bg-orange-400 hover:bg-orange-500 rounded text-white font-bold py-2 px-4 my-4  inline-flex items-center">
                                View
                            </button></td>
                        </tr>
                        <?php } ?>
